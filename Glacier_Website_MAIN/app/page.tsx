            ...
            {[
              ...
              <Card key={index} className="overflow-hidden shadow-lg hover:shadow-xl transition-shadow">
                ...
                <CardContent className="p-6">
                  ...
                  <Link href={`/gis-map?basin=${basin.name.toLowerCase().replace(" ", "-")}`}>
            ...
            {[
              {
                ...
                description: "Continuous tracking of glacial lake changes and movements",
              },
              {
                icon: AlertTriangle,
                title: "Risk Assessment",
                description: "Advanced analysis of potential flood risks and hazards",
              },
              {
                icon: BarChart3,
                title: "Data Analysis",
                description: "Comprehensive tools for data visualization and interpretation",
              },
              {
                icon: FileText,
                title: "Report Generation",
                description: "Automated generation of detailed analysis reports",
              },
            ].map((feature, index) => (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-8">
                Access comprehensive data visualization tools and interactive maps for detailed analysis of glacial lake
                systems.
              </p>
              <div className="space-y-4 mb-8">
                <div className="flex items-center space-x-3">
                  <div className="w-2 h-2 bg-blue-600 rounded-full"></div>
                  <span className="text-gray-700">Multiple Layers</span>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="w-2 h-2 bg-blue-600 rounded-full"></div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              },
              {
                icon: Database,
                title: "Datasets",
                description: "Access raw geospatial data",
                link: "/data",
              },
              {
                icon: BookOpen,
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                <li>
                  <Link href="/gis-map" className="hover:text-white">
                    Interactive Map
                  </Link>
                </li>
                <li>
